...
TARGET_FILE = Path("src/nfl_api/lib/data.py")
...
def extract_active_players(items):
    players = []
    for item in items:
...
def write_to_file(players):
    ...
    with open(TARGET_FILE, "w") as f:
        f.write("# DO NOT MODIFY: This file has been auto-generated by nfl_api/scripts/generate_active_players.py.\n")
...
async def main():
    ...
    active_players = extract_active_players(items)
    write_to_file(active_players)
    print(f"Wrote {len(active_players)} active players to {TARGET_FILE}")
